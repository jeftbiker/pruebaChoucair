...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target BUTTON_GO = Target.the("Da clcik para buscar el curso").located(By.xpath("//button[@class= 'btn btn-secundary')]"));
    public static final Target SELECT_COURSE = Target.the("Da clcik para buscar el curso").located(By.xpath("//h4[contains(text(), 'Recursos Automatización Bancolombia')]"));
