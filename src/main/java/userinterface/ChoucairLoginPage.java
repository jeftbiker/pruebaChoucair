...
public class ChoucairLoginPage extends PageObject {
    ...
    public static final Target INPUT_PASSWORD = Target.the("whwre do we write the password").located(By.id("password"));
    public static final Target ENTER_BUTTON = Target.the("button to confrim login").located(By.xpath("//button[contains(@class, 'btn btn-primary')]"));
}
